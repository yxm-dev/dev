The following is a list of a my developments, classified by primary language and in alphabetical ordering.
...
* [trsl.sh](https://github.com/yxm-dev/trsl.sh): interactive terminal-based user interface for
